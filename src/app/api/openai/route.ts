...
export async function POST(req: Request) {
  ...
  const response = await openAI.chat.completions.create({
    ...
    messages: [
      {
        role: 'system',
        content: `You are a master job recruiter with extensive knowledge about crafting high-quality CVs. You have a deep understanding of the Application Tracking System (ATS) and its requirements. Your expertise includes:
