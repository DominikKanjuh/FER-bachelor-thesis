  ...
  return (
    <>
      <main className="flex-1 flex flex-col">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] md:text-xl text-muted-foreground">
                    Our intuitive drag and drop editor allows you to easily
                    customize your CV. Get personalized suggestions to enhance
                    your resume based on the job description.
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-center items-center">
                <div className="bg-secondary rounded-lg p-6 w-full">
                  <h2 className="text-2xl text-secondary-foreground font-bold mb-4">
                    Drag & Drop Editor
                  </h2>
                  <p className="text-muted-foreground mb-6">
                    Easily customize your CV with our intuitive drag and drop
                    editor.
                  </p>
                  <div className="border-2 border-dashed border-secondary-foreground rounded-lg p-8 flex justify-center items-center">
                    ...
                    <span className="ml-2  text-secondary-foreground">
                      Edit your CV visually with ease
                    </span>
                  </div>
                </div>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48  border-t">
          <div className="container px-4 md:px-6">
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className=" text-muted-foreground">
                        Our AI suggests keywords to help you tailor your CV for
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className=" text-muted-foreground">
                        Our AI analyzes your CV and the job description to
                        provide personalized suggestions on how to improve your
                        resume.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className=" text-muted-foreground">
                        Easily update your CV with our intuitive drag and drop
                        editor.
                      </p>
                    </div>
                  </li>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          &copy; 2024 CV-improver. All rights reserved.
        </p>
